...
%	\begin{prop}
%		For each $i$, $n_i$ divides $n_{i+1}$ (if $n_{i+1}$ exists).
%	\end{prop}
%	\begin{proof}
%		Let $d=(n_i,n_{i+1})$. Then $x_0\meet x_d=x_0\meet x_{n_i}$ and $d$ divides $n_i$. By minimality of $n_i$, it follows that $n_i=d$.
%	\end{proof}
